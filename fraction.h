...
class fraction
{
    public:
        fraction();
        fraction(long long int n, long long int d);                                 //removed the d=(long long int)1   1/14/14
       // fraction(const long long int &n, const long long int &d = (long long int)1);  //ed 1/14/14
        fraction(double v);
